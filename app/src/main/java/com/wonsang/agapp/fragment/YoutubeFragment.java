...
public class YoutubeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new SearchViewTextListener(getString(R.string.youtube_request_url), getString(R.string.youtube_api_key), getContext(), this));
    ...
    public void setYoutubeDataFetch(List<YoutubeData> youtubeData) {
        YoutubeAdapter adapter = Objects.requireNonNull((YoutubeAdapter)recyclerView.getAdapter());
        adapter.setYoutubeData(youtubeData);
    ...
    static class SearchViewTextListener implements SearchView.OnQueryTextListener {
        ...
        SearchViewTextListener(String requestUrl, String key, Context context, YoutubeFragment youtubeFragment) {
            dataProvider = new YoutubeDataProvider(requestUrl, key, context, youtubeFragment);
        }
    ...
    static class YoutubeAdapter extends RecyclerView.Adapter<YoutubeViewHolder> {
        ...
        public void setYoutubeData(List<YoutubeData> youtubeData) {
